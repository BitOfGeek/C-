...
{
    public class ListViewContentResizeBehaviour
    {
        #region DependencyProperties
        public static readonly DependencyProperty WidthProperty =
            DependencyProperty.RegisterAttached("Width", typeof(string), typeof(ListViewContentResizeBehaviour),
                                                new PropertyMetadata(OnSetWidthCallback));

        public static readonly DependencyProperty GridViewColumnResizeBehaviorProperty =
            DependencyProperty.RegisterAttached("ListViewContentResizeBehaviour",
                                                typeof(GridViewColumnResizeBehavior), typeof(ListViewContentResizeBehaviour), null);

        public static readonly DependencyProperty EnabledProperty =
            DependencyProperty.RegisterAttached("Enabled", typeof(bool), typeof(ListViewContentResizeBehaviour),
        ...
        public static readonly DependencyProperty ListViewResizeBehaviorProperty =
            DependencyProperty.RegisterAttached("ListViewResizeBehaviorProperty",
                                                typeof(ListViewResizeBehavior), typeof(ListViewContentResizeBehaviour), null);
        #endregion
